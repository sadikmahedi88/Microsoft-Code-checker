...
def banner():
    ...
    LB = Fore.LIGHTBLACK_EX + Style.BRIGHT
    print(f'''
{P}
╭───────────────────────────────────────────────────────────────────────────╮
{P}│ {C}╔═══════════════════════════════════════════════════════════════════════╗{P} │
...
{P}│ {C}║      {E}╚═╝     ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝     ╚═╝  ╚═╝   ╚═╝   {C}            ║{P} │
{P}│ {C}║                                                              {C}         ║{P} │
{P}│ {C}║                 {LB} MURPHY TOOL TIKTOK IMAP v1.0            {C}             ║{P} │
{P}│ {C}║                                                              {C}         ║{P} │
{P}│ {C}║                      {LB}Developer: @pypkg                  {C}              ║{P} │
{P}│ {C}║                       {LB}Channel: https://t.me/+zZUKD1RHroA5ODc8   {C}      ║{P} │
{P}│ {C}╚═══════════════════════════════════════════════════════════════════════╝{P} │
{P}╰───────────────────────────────────────────────────────────────────────────╯''')
...
def update_titlebar(results_count, processed_count, total_codes):
    ...
    title = f"Code checker by @pypkg | Checked: {processed_count}/{total_codes} | VALID: {valid_count} | VALIDPI: {validpi_count} | Region Locked: {region_locked_count} | Invalid: {invalid_count}"
